...
export type PlasmicButtonButton__VariantsArgs = {
  ...
  isRound?: SingleBooleanChoiceArg<"isRound">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.isRound
      }
    ],
    [$props, $ctx, $refs]
  );
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootisDisabled_language_iconOnly]:
            hasVariant($state, "language", "iconOnly") &&
            hasVariant($state, "isDisabled", "isDisabled"),
          [sty.rootisRound]: hasVariant($state, "isRound", "isRound"),
      ...
      <Embed
        className={classNames("__wab_instance", sty.embedHtml__bNcN9, {
          ...
          [sty.embedHtmltype_outline_isDisabled_color_themeSecondary__bNcN97H8Vd8RpIwCEAJ]:
            ...
            hasVariant($state, "isDisabled", "isDisabled") &&
            hasVariant($state, "type", "outline"),
          [sty.embedHtmltype_outline_isDisabled_language_iconOnly__bNcN97H8Vd8RpIwUiqRd]:
            hasVariant($state, "isDisabled", "isDisabled") &&
            hasVariant($state, "language", "iconOnly") &&
            hasVariant($state, "type", "outline")
        })}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicButtonButton__ArgsType, ReservedPropsType> &
