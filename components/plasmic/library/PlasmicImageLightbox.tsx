    ...
    >
      ...
      >
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__kSjzz, {
            [sty.freeBoxopen__kSjzzy196S]: hasVariant($state, "open", "open")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__rXHd, {
              [sty.freeBoxopen__rXHDy196S]: hasVariant($state, "open", "open")
            })}
            dir={"rtl"}
          >
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              ...
              return (
                <div
                  className={classNames(projectcss.all, sty.freeBox___7RFWo, {
                    [sty.freeBoxopen___7RFWoy196S]: hasVariant(
                      $state,
                      "open",
                      "open"
                    )
                ...
                >
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__liOo, {
                      [sty.imgopen__liOOy196S]: hasVariant(
                        $state,
                        "open",
                        "open"
                      )
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicImageLightbox__ArgsType, ReservedPropsType> &
