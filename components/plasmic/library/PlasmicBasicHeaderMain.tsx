...
export type PlasmicBasicHeaderMain__VariantsArgs = {
  ...
  shrink?: SingleBooleanChoiceArg<"shrink">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.shrink
      }
    ],
    [$props, $ctx, $refs]
  );
    ...
    <header
      ...
      className={classNames(
        ...
        sty.headerBase,
        {
          ...
          [sty.headerBaseshrink]: hasVariant($state, "shrink", "shrink")
        }
      )}
      dir={args.dir}
      id={args.id}
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__pSVr, {
          ...
          [sty.freeBoxshrink__pSVrbnilh]: hasVariant($state, "shrink", "shrink")
        })}
      >
        <Stack__
          as={"div"}
          ...
          className={classNames(projectcss.all, sty.contentContainer, {
            ...
            [sty.contentContainerheaderType_appHeader_open]:
              hasVariant($state, "open", "open") &&
              hasVariant($state, "headerType", "appHeader"),
        ...
        >
          <Stack__
            ...
            className={classNames(projectcss.all, sty.freeBox___6K8F, {
              ...
              [sty.freeBoxheaderType_appHeader_open___6K8FQjU8RzV0Y]:
                hasVariant($state, "open", "open") &&
                hasVariant($state, "headerType", "appHeader"),
              [sty.freeBoxopen___6K8FRzV0Y]: hasVariant($state, "open", "open"),
              [sty.freeBoxshrink___6K8Fbnilh]: hasVariant(
                $state,
                "shrink",
                "shrink"
              )
          ...
          >
            ...
            <Stack__
              ...
              className={classNames(projectcss.all, sty.freeBox___3PKz7, {
                ...
                [sty.freeBoxshrink___3PKz7Bnilh]: hasVariant(
                  $state,
                  "shrink",
                  "shrink"
                )
              ...
              <ButtonButton
                className={classNames(
                  ...
                  sty.buttonButton__gaW0S,
                  {
                    ...
                    [sty.buttonButtonshrink__gaW0Sbnilh]: hasVariant(
                      $state,
                      "shrink",
                      "shrink"
                    )
                ...
                language={"iconOnly"}
                link={
                  hasVariant($state, "shrink", "shrink")
                    ? "https://support.sindibad.iq/"
              ...
              <ButtonButton
                className={classNames(
                  ...
                  sty.buttonButton__bjkyy,
                  {
                    ...
                    [sty.buttonButtonshrink__bjkyybnilh]: hasVariant(
                      $state,
                      "shrink",
                      "shrink"
                    )
                ...
                startIcon={
                  ...
                  hasVariant(globalVariants, "screen", "mobileBig")
                    ...
                    : '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 6H21V8H3V6ZM3 11H21V13H3V11ZM3 16H21V18H3V16Z" fill="currentcolor"/></svg>'
                }
                type={"link"}
              />
            </Stack__>
          ...
          <Stack__
            ...
            className={classNames(projectcss.all, sty.freeBox__ehg7G, {
              ...
              [sty.freeBoxshrink__ehg7Gbnilh]: hasVariant(
                $state,
                "shrink",
                "shrink"
              )
          ...
          >
            <ButtonDrop
              className={classNames("__wab_instance", sty.buttonDrop___2De4N, {
                ...
                [sty.buttonDropheaderType_appHeader_open___2De4NQjU8RzV0Y]:
                  hasVariant($state, "open", "open") &&
                  hasVariant($state, "headerType", "appHeader"),
                ...
                return (
                  <PlasmicLink__
                    className={classNames(
                      ...
                      sty.link__cl5N9,
                      {
                        [sty.linkheaderType_appHeader_open__cl5N9QjU8RzV0Y]:
                          hasVariant($state, "open", "open") &&
                          hasVariant($state, "headerType", "appHeader")
                      }
                    )}
            ...
            >
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                (() => {
                  try {
                    return [
                      // ['أفضل العروض', 'Best Deals', `<svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      // <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1496 6.67181C14.0368 6.22055 17.9631 6.22054 21.8503 6.6718L10.1496 6.67181ZM21.8503 6.6718C22.4951 6.74697 23 7.31018 23 8.00917V24.658L20.3714 23.6066C20.133 23.5112 19.867 23.5112 19.6286 23.6066L16 25.058L12.3714 23.6066C12.133 23.5112 11.867 23.5112 11.6286 23.6066L8.99998 24.658V8.00917C8.99998 7.30976 9.50414 6.74693 10.1496 6.67181M9.9188 4.68517C13.9594 4.21609 18.0406 4.21609 22.0812 4.68517C23.7829 4.88319 25 6.34451 25 8.00917V26.135C25 26.4669 24.8354 26.7771 24.5606 26.9631C24.2858 27.1491 23.9367 27.1867 23.6286 27.0635L20 25.6121L16.3714 27.0635C16.133 27.1589 15.867 27.1589 15.6286 27.0635L12 25.6121L8.37138 27.0635C8.06328 27.1867 7.71413 27.1491 7.43936 26.9631C7.16458 26.7771 6.99998 26.4669 6.99998 26.135V8.00917C6.99998 6.3449 8.21554 4.88319 9.9188 4.68517ZM19.9071 11.0279C20.2976 11.4185 20.2976 12.0516 19.9071 12.4421L13.5071 18.8421C13.1166 19.2327 12.4834 19.2327 12.0929 18.8421C11.7024 18.4516 11.7024 17.8185 12.0929 17.4279L18.4929 11.0279C18.8834 10.6374 19.5166 10.6374 19.9071 11.0279Z" fill="currentcolor"/>
                      // <path fill-rule="evenodd" clip-rule="evenodd" d="M12.2667 12.535C12.2667 11.7986 12.8636 11.2017 13.6 11.2017H13.6085C14.3449 11.2017 14.9419 11.7986 14.9419 12.535V12.5435C14.9419 13.2799 14.3449 13.8769 13.6085 13.8769H13.6C12.8636 13.8769 12.2667 13.2799 12.2667 12.5435V12.535ZM17.0667 17.335C17.0667 16.5986 17.6636 16.0017 18.4 16.0017H18.4085C19.1449 16.0017 19.7419 16.5986 19.7419 17.335V17.3435C19.7419 18.0799 19.1449 18.6769 18.4085 18.6769H18.4C17.6636 18.6769 17.0667 18.0799 17.0667 17.3435V17.335Z" fill="currentcolor"/>
                      // </svg>`, "https://sindibad.iq/deals"],
                      [
                        "معلومات المطار",
                        "Airport Information",
                        `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.75 9.12372C6.75 10.3593 7.34746 12.1575 8.48917 14.2851C9.00357 15.2437 9.58506 16.1908 10.1776 17.0826C10.9902 18.3058 12.7573 18.3058 13.5699 17.0826C14.1624 16.1908 14.7439 15.2437 15.2583 14.2851C16.4 12.1575 16.9974 10.3593 16.9974 9.12372C16.9974 6.37126 14.6262 4 11.8737 4C9.12126 4 6.75 6.37126 6.75 9.12372ZM15.3398 9.12372C15.3398 9.93627 14.9065 11.4348 13.7976 13.5013C13.3132 14.4041 12.7601 15.306 12.1892 16.1653C12.0324 16.4013 11.7151 16.4013 11.5583 16.1653C10.9874 15.306 10.4343 14.4041 9.94983 13.5013C8.84091 11.4348 8.40767 9.93627 8.40767 9.12372C8.40767 7.28676 10.0368 5.65767 11.8737 5.65767C13.7107 5.65767 15.3398 7.28676 15.3398 9.12372Z" fill="currentcolor"/>
                      ...
                      // ['معلومات طيران', 'Popular Flights', `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      // </svg>`, "https://sindibad.iq/popular-flights"],
                      [
                        "مسارات الجوية",
                        "Popular Routes",
                        `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M18.0515 4.54288C18.0515 4.01788 17.5265 3.49288 17.0015 3.49288C16.4765 3.49288 15.9515 3.93038 15.9515 4.54288C15.9515 5.06788 16.389 5.59288 17.0015 5.59288C17.614 5.59288 18.139 5.06788 18.0515 4.54288Z" fill="currentcolor"/>
                      ...
                      // ['تصنيف الطيران','Airlines Leaderboard',`<svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      // </svg>`,"https://sindibad.iq/airlines-leaderboard"]
                    ];
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
          ...
          <Stack__
            ...
            className={classNames(projectcss.all, sty.freeBox__fHkoa, {
              ...
              [sty.freeBoxshrink__fHkoabnilh]: hasVariant(
                $state,
                "shrink",
                "shrink"
              )
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicBasicHeaderMain__ArgsType, ReservedPropsType> &
