  ...
  return (
    ...
    >
      ...
      <ButtonButton
        ...
        link={(() => {
          try {
            return `https://sindibad.iq/flight/from-${$props.originIata.toLowerCase()}-to-${$props.destinationIata.toLowerCase()}`;
          } catch (e) {
            if (
              e instanceof TypeError ||
              e?.plasmicType === "PlasmicUndefinedDataError"
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCardRoute__ArgsType, ReservedPropsType> &
